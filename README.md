...
## Example commit plan
1. create interface `MyList`
2. implement `MyArrayList`
3. add tests for `MyArrayList`
4. implement `MyLinkedList`
5. add tests for `MyLinkedList`
6. implement `MyStack` and `MyQueue`
7. implement `MyMinHeap`
8. add README and final cleanup
